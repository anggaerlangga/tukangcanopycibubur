			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('admin/banner/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">
						...
						<!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
							...
							<input type="hidden" name="id" value="<?php echo $banner->banner_id?>" />

							<div class="form-group">
								<label for="title">Title</label>
								<input class="form-control <?php echo form_error('title') ? 'is-invalid':'' ?>"
								 type="text" name="title" placeholder="Title" value="<?php echo $banner->title ?>" />
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('subtitle') ? 'is-invalid':'' ?>"
								 type="text" name="subtitle" placeholder="subtitle" value="<?php echo $banner->subtitle ?>" />
								<div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('description') ? 'is-invalid':'' ?>"
								 type="text" name="description" placeholder="description" value="<?php echo $banner->description ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('createdby') ? 'is-invalid':'' ?>"
								 type="text" name="createdby" placeholder="createdby" value="<?php echo $banner->createdby ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('createdon') ? 'is-invalid':'' ?>"
								 type="text" name="createdon" placeholder="createdon" value="<?php echo $banner->createdon ?>" />
								<div class="invalid-feedback">
